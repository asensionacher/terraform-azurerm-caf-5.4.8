locals {
  ...
  combined_objects_function_apps_access_policy                    = merge(tomap({ (local.client_config.landingzone_key) = module.function_apps_access_policy  }), try(var.remote_objects.function_apps_access_policy , {}))
